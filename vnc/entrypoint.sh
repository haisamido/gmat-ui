...
# Set up environment for all GUI applications (must be before vncserver
# so the entire X session, including fluxbox menu launches, inherits these)
...
# Start VNC server (inherits environment above)
